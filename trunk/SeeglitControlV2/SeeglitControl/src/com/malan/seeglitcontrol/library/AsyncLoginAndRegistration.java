...
public class AsyncLoginAndRegistration extends AsyncTask<String, String, JSONObject>{
	...
	// JSON Response node names
		...
		private static String KEY_SOCIETY_SID="sid";
		private static String KEY_SOCIETY_UID="uid";
		private static String KEY_SOCIETY_NAME="name";
...
//					DatabaseHandler db = new DatabaseHandler(context);
					...
					JSONObject json_society = json.getJSONObject("society");
					JSONArray json_nat = json.getJSONArray("nat");
					// Clear all previous data in database
					userFunction.logoutUser(context);
					db.addUser(json_user.getString(KEY_NAME), json_user.getString(KEY_EMAIL), json.getString(KEY_UID), json_user.getString(KEY_CREATED_AT));
					db.addSociety(json_society.getString(KEY_SOCIETY_UID), json_society.getString(KEY_SOCIETY_NAME), json_society.getString(KEY_SOCIETY_SID));
