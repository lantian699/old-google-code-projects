...
//	// the DAO object we use to access the SimpleData table
	...
	public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
		try {
			...
			TableUtils.createTable(connectionSource, Society.class);
	...
	public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion, int newVersion) {
		try {
			...
			TableUtils.dropTable(connectionSource, Society.class, true);
	...
	public Dao<Society, Integer> getSocietyDao() throws SQLException {
		if (societyDao == null) {
			societyDao = getDao(Society.class);
		}
		return societyDao;
	}
	...
	public void addSociety(String uid, String name, String sid ) throws SQLException{
		
		Society society = new Society();
		society.setName(name);
		society.setSid(sid);
		society.setUid(uid);
		this.getSocietyDao().create(society);
	}
