...
public class Test03 implements Renderer, OnTouchListener
{
	...
	private float[] lightDiffuse = {3.0f, 5.0f, 2.0f, 7.0f};//1.0f, 1.0f, 1.0f, 1.0f
	private float[] lightPosition = {0.0f, -0.0f, 2.0f, 1.0f};//0.0f, 0.0f, 2.0f, 1.0f
	...
	public Test03(Context context)
	{
		...
		LoadObjData loadObjData=new LoadObjData(context,"e31104100.data");
		ObjData objData=loadObjData.getObjData();
		simba01=new Shape(objData.getVertices(),objData.getNormals(),objData.getIndices());
...
//		gl.glEnable(GL10.GL_TEXTURE_2D);			//Enable Texture Mapping
	...
	public void onDrawFrame(GL10 gl)
	{
		...
		//Drawing
		gl.glTranslatef(-0.5f, 0.0f, -5.0f);	//Move down 1.0 Unit And Into The Screen 7.0
