...
public class YearsActivity extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu03:
    		...
    		in.setClass(YearsActivity.this, CatalogActivity.class);
    		close();
    	    //  显示Activity1
    	    startActivity(in);
    ...
    public void arrowLeftOnClick(View view){
		...
		in.setClass(YearsActivity.this, AffichageActivity.class);
		in.putExtras(bundle);
		this.finish();
	    //  显示Activity1
	    startActivity(in);
...
//		//List listEtudiants = racine.getChildren("string");
		...
		//System.out.println(courant.getText());
			 ...
			 HashMap<String, Object> map = new HashMap<String, Object>();  
	            ...
	            listItemAdapter = new SimpleAdapter(YearsActivity.this,listItem, R.layout.bookmark,//ListItem的XML实现  
