...
public class CatalogActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listViewCatalog = (ListView)findViewById(R.id.list1);
        listItem1 = new ArrayList<HashMap<String, String>>();  //ArrayList<HashMap<String, Object>> 
       // System.out.println(mainlist1+"***********");
        
 
        AddCatalog(getString(R.string.di0) ); 
//        AddCatalog(getString(R.string.di1) );
//        AddCatalog(getString(R.string.di2) );
//        AddCatalog(getString(R.string.di3) );
//        AddCatalog(getString(R.string.di4) );
//        AddCatalog(getString(R.string.di5) );
//        AddCatalog(getString(R.string.di6) );
//        AddCatalog(getString(R.string.di7) );
//        AddCatalog(getString(R.string.di8) );
//        AddCatalog(getString(R.string.di9) );
//        AddCatalog(getString(R.string.dia) );
//        AddCatalog(getString(R.string.dib) );
//        AddCatalog(getString(R.string.dic) );
//        AddCatalog(getString(R.string.did) );
//        AddCatalog(getString(R.string.die) );
//        AddCatalog(getString(R.string.dif) );
//        AddCatalog(getString(R.string.dig) );
//        AddCatalog(getString(R.string.dih) );
//        AddCatalog(getString(R.string.dii) );
//        AddCatalog(getString(R.string.dij) );
//        AddCatalog(getString(R.string.dik) );
//        AddCatalog(getString(R.string.dil) );
//        AddCatalog(getString(R.string.dim) );
//        AddCatalog(getString(R.string.din) );
//        AddCatalog(getString(R.string.dio) );
//        AddCatalog(getString(R.string.dip) );
//        AddCatalog(getString(R.string.diq) );
//     
        ...
        listViewCatalog.setAdapter (listItemAdapter);
